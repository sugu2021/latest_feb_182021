...
$data = [ 'name' => $_POST['name'], 'email' =>$_POST['email'], 'phone' =>$_POST['phone'] , 'company' =>$_POST['company'],'service' =>$_POST['service'], 'message' =>$_POST['message']];

header('Content-type: application/json');
echo json_encode( $data );

    $to = 'info@brandstory.in';
    $subject = "BSTY new lead Case Study Enquiry | ". $_POST['company']."";
    $message = "
    <html>
    <head>
    </head>
